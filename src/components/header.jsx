...
function Header() {
    ...
    return (
        <div className="w-full flex gap-4 justify-between px-3 h-14 bg-white fixed top-0 z-10 shadow-lg">
            ...
            {/* Navigation */}
            <div className="flex-1 flex gap-2 justify-center pt-1 *:w-16 max-md:justify-start">
            ...
            <div className="flex-1 flex gap-3 justify-end">
                <div className="avatar justify-center items-center">
                    <div className="w-10 h-10 rounded-full flex! justify-center items-center bg-base-200 hover:bg-base-300">
